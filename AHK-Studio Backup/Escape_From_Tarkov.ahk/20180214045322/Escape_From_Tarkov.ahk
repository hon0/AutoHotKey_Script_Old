...
{ ;Before running a Game. Run and/or close Program.
	...
	#t::
	{
		...
		Else If !WinExist("WhiteKnight Auto-Whitelister for HidCerberus")
		{
			Run, D:\-  Téléchargements sur D\WhiteKnight\AutoWhitelister.exe
			WinWait WhiteKnight Auto-Whitelister for HidCerberus
			WinMinimize WhiteKnight Auto-Whitelister for HidCerberus
		}
		Else If !WinExist("EFT.xml - Joystick Gremlin")
		{
			Run, C:\Program Files (x86)\H2ik\Joystick Gremlin\joystick_gremlin.exe
			WinWait EFT.xml - Joystick Gremlin
		}
